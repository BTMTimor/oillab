...
public class HtmlUtils {
	...
	public static String delHTMLTag(String htmlStr) {
		// 过滤script标签
		htmlStr = p_script.matcher(htmlStr).replaceAll(EMPTY_STRING);

		// 过滤style标签
		htmlStr = p_style.matcher(htmlStr).replaceAll(EMPTY_STRING);

		// 过滤html标签
		htmlStr = p_html.matcher(htmlStr).replaceAll(EMPTY_STRING);
