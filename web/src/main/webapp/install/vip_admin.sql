...
-- ----------------------------
INSERT INTO `vip_must_auth_group` VALUES ('1', '超级管理组', '1', '100,101,102,103,104,105,106,107,108,109,110,111,112,113');
INSERT INTO `vip_must_auth_group` VALUES ('2', '普通管理员', '1', '100,102,103,104,105,106,109,111,112,113');
...
-- ----------------------------
INSERT INTO `vip_must_auth_rule` VALUES ('106', '基本信息', 'admin/System/index', '100', '1', '', '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('107', '菜单管理', 'admin/Nav/index', '101', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('108', '权限组', 'admin/System/auth', '101', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('109', '普通用户', 'admin/User/index', '102', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('110', '系统用户', 'admin/SystemUser/index', '102', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('111', '修改密码', 'admin/SystemUser/edit_password', '102', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('112', '日志记录', 'admin/Log/index', '103', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('113', '数据库备份', 'admin/Bak/index', '104', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('100', '系统配置', '', '0', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('101', '系统管理', '', '0', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('102', '用户管理', '', '0', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('103', '日志管理', '', '0', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('104', '数据库管理', '', '0', '1', null, '0', null, '1');
INSERT INTO `vip_must_auth_rule` VALUES ('105', '后台配置', 'admin/System/config', '100', '1', null, '0', null, '1');
...
CREATE TABLE `vip_must_back_sql` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='数据库备份表';
...
-- ----------------------------
INSERT INTO `vip_must_config` VALUES ('1', '{\"title\":\"vip-admin \\u7ba1\\u7406\\u7cfb\\u7edf\",\"version\":\"v1.0.0\",\"copy\":\"Copyright \\u00a92017 [\\u4f7f\\u7528\\u8005\\u7f51\\u7ad9] Powered By [\\u7f51\\u7ad9\\u7a0b\\u5e8f\\u540d\\u79f0] Version 1.0.0\",\"icp\":\"\\u67d0ICP\\u5907200902xxxx\",\"code\":\"javascript:baidutongji();\"}');
...
CREATE TABLE `vip_must_system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1638 DEFAULT CHARSET=utf8 COMMENT='用户操作日志记录表';
...
-- ----------------------------
INSERT INTO `vip_must_system_user` VALUES ('1', 'admin', '39b06ad92d56e6445a58096d77b39f48', '2017-03-18 18:38:51', '0.0.0.0', '2016-10-18 15:28:37', '1');
INSERT INTO `vip_must_system_user` VALUES ('2', 'root', '39b06ad92d56e6445a58096d77b39f48', '2017-03-18 18:38:18', '0.0.0.0', '2017-02-23 16:10:53', '1');
