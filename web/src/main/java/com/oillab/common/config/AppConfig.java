...
import com.jfinal.ext.handel.AuthHandler;
...
import com.oillab.common.handel.*;
import com.oillab.common.util.Console;
...
//        String[] scanPackages = configKit.getScanPackages().split("\\|");
        ...
        com.jfinal.ext.util.Console.info("WebRootPath: %s", PathKit.getWebRootPath());
        com.jfinal.ext.util.Console.info("RootClassPath: %s", PathKit.getRootClassPath());
        com.jfinal.ext.util.Console.info("JavaClassPaths: %s", Arrays.toString(ClassScanUtil.getJavaClassPaths()));
    }
...
//        engine.setBaseTemplatePath(PathKit.getRootClassPath());
    ...
    public void configConstant(Constants constants) {
        ...
        constants.setViewExtension(configKit.getViewExtension());
        constants.setUrlParaSeparator(configKit.getUrlParaSeparator());
        constants.setDenyAccessJsp(configKit.isDenyAccessJsp());
        ...
        // 国际化
        constants.setI18nDefaultBaseName("lang/i18n");
        constants.setI18nDefaultLocale("en_US");

        constants.setError401View("/static/errorPage/zh-CN/401.htm");
        constants.setError403View("/static/errorPage/zh-CN/403.htm");
        constants.setError404View("/static/errorPage/zh-CN/404.htm");
        constants.setError500View("/static/errorPage/zh-CN/500.htm");
        constants.setError500View("/static/errorPage/zh-CN/501.htm");
        constants.setError500View("/static/errorPage/zh-CN/502.htm");
    ...
    public void configEngine(Engine engine) {
        ...
        System.out.println("[configEngine] " + engine.getBaseTemplatePath());
        ...
        // 所有模板
        engine.addSharedFunction("view/base/allSharedFunctions.jf");
        // 通用模板：测试
    }
    ...
    public void configPlugin(Plugins plugins) {
        ...
        // 所有映射(model: table)在 MappingKit 中自动化搞定
        ...
        System.out.println("[configPlugin] " + engine.getBaseTemplatePath());
        engine.setDevMode(configKit.isDevMode());
