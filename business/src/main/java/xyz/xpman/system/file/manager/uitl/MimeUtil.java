...
public class MimeUtil {
    private static final Map<String, String> allowMimeType = new HashMap<String, String>(){{
        put("323", "text/h323");
    ...
    public static boolean checkType(String mineType, String fileExtension){
        if(StrKit.notBlank(mineType, fileExtension)) {
            return (allowMimeType.containsKey(mineType)
                    && fileExtension.equals(allowMimeType.get(mineType)));
        }
        return false;
    }
